export class Constants {
  ...
  public static ORDPC_CLARO_LOADED: string = 'ORDPC_CLARO_LOADED';
  public static ORDPC_ERICSSON_PROCESED: string = 'ORDPC_ERICSSON_PROCESED';
  public static ORDPC_ERICSSON_ERROR: string = 'ORDPC_ERICSSON_ERROR';
  ...
  public static REQUIRED_CONSTANTS: string[] = [
    ...
    Constants.ORDPC_CLARO_LOADED,
    Constants.ORDPC_ERICSSON_PROCESED,
    Constants.ORDPC_ERICSSON_ERROR
  ];
}
