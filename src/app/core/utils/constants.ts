export class Constants {
  ...
  public static ORDPC_CONSUME_LIST_ORDER_ERROR: string = 'ORDPC_CONSUME_LIST_ORDER_ERROR';
  public static ORDPC_CONSUME_DOWNLOAD_ORDER_ERROR: string = 'ORDPC_CONSUME_DOWNLOAD_ORDER_ERROR';
  public static LIST_ORDER_ERROR_ERROR: string = 'ORDPC_LIST_ORDER_ERROR_ERROR';
  public static DOWNLOAD_ORDER_ERROR: string = 'ORDPC_DOWNLOAD_ORDER_ERROR';
  ...
  public static REQUIRED_CONSTANTS: string[] = [
    ...
    Constants.ORDPC_CONSUME_LIST_ORDER_ERROR,
    Constants.ORDPC_CONSUME_DOWNLOAD_ORDER_ERROR,
    Constants.LIST_ORDER_ERROR_ERROR,
    Constants.DOWNLOAD_ORDER_ERROR,
  ];
}
